...
project = "{{cookiecutter.lesson_name}}"
copyright = "{% now 'local', '%Y' %}, {{ cookiecutter.full_name }} and individual contributors."
author = "{{cookiecutter.full_name}} and individual contributors."
github_user = "{{cookiecutter.github_username}}"
github_repo_name = "{{cookiecutter.lesson_slug}}"
github_version = "{{cookiecutter.default_branch}}"
...
html_logo = "img/{{cookiecutter.html_logo}}"
html_favicon = "img/{{cookiecutter.html_favicon}}"
